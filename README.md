...
* 1.5 вывод размапленой информации по директорям basereloc, exceptions, security, boundimport, com
* 1.6 вывод размапленой информации по директории resources
* 1.6 вывод используемых ресурсов в удобочитаемом виде
* 1.7 вывод размапленой информации по директории debug
* 1.7 поддержка отладочных PBD файлов
* 1.7 перевод вывода системных структур на основе полученных данных из PDB
* 1.8 поддержка отладочной информации JclDebug (возможно в виде плагина)
