...
* добавлены модули для работы с ELF исполняемыми и обьектными файлами, а также с обьектными COFF файлами
* добавлен модуль генерации МАР файла на основе DWARF информации
* добавлена внешняя утилита dwarfreader.exe для получения информации об отладочной DWARF информации без создания нового процесса.
