...
1.6.47 от 10.05.2026
* Добавлен вывод информации по ресурсам процесса
* Доработан вывод импорта/экспорта ELF файлов в плагине dwarfreader
* Для части модулей (ELF) добавлена поддержка Lazarus для использования в Linux
* Загрузка отладочной информации теперь настраиваемая через TImageLoadType

1.5.46 от 28.02.2025
* Исправлена ошибка "Division by zero." при чтении DWARF у исполняемых файлов с малым обьемом отладочной информации.
