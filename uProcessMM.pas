...
//
//   ѕроцедура рассчитывает количество всех отображаемых узлов
// =============================================================================
...
//
//   ѕроцедура инициализирует дерево
// =============================================================================
...
var
  ...
  var
    I: Integer;
  begin
    // директории и секции вывод€тс€ только в случае отсутви€ фильтра
...
begin
  ...
  try
    ...
    // –ассчитываем общее количество узлов
    ...
    begin
      ...
      // –ассчитываем доппараметры, дл€ более красивого отображени€ узлов
      // второго уровн€. NodesColor отвечает за цвет подэлементов,
      ...
      // ѕроверка, присутствуют ли скрытые узлы?
      if Region.HiddenRegionCount > 0 then
      begin
        // если присутствуют, добавл€ем их...
        ...
        begin
          ...
          // у узлов второго уровн€ всегда выводитс€ список директорий
      ...
      begin
        ...
        // а у узлов первого уровн€ директории и доп информаци€ вывод€тс€ только
        // в тех случа€х, если отсутствую скрытые узлы
