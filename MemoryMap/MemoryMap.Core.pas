...
const
  MemoryMapVersionInt = $01041D00;
  {$MESSAGE 'Версию генерить из версии экзехи'}
  MemoryMapVersionStr = '1.4 (revision 29)';
